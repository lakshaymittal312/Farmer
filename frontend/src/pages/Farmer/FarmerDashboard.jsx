...
import { Package, DollarSign, Star, PlusCircle, ArrowUpRight, Clock } from 'lucide-react';
...
const FarmerDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const pRes = await farmerApi.getProfile();
      if (pRes.data.success) setProfile(pRes.data.data);

      // 2. Fetch Products
      const prRes = await productApi.getProducts();
      ...
      // 3. Fetch Orders
      const oRes = await orderApi.getFarmerOrders();
